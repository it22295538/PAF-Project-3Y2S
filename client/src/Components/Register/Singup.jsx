    ...
    <div>
      ...
      <img
        ...
        <p className="font-bold opacity-50 text-lg mb-10 text-center">
          Experience the valuable experience with LevelUp.
        </p>
        <Formik
        ...
        >
          {(formikProps) => (
            <Form className="w-full">
              ...
              <Field name="username">
                {({ field, form }) => (
                  <FormControl
                    ...
                    mb={4}
                  >
                    <Input {...field} id="username" placeholder="Please Enter Your Username" />
              ...
              <Field name="name">
                {({ field, form }) => (
                  <FormControl
                    ...
                    mb={4}
                  >
                    <Input {...field} id="name" placeholder="Please Enter Your Full Name" />
              ...
              Sign in to the LevelUp  for experience the valuable skills experience .
              </p>
              <Button
                className="w-full"
                mt={4}
